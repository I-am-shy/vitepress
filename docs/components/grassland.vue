...
onMounted(() => {
  ...
  scene.background = new THREE.CubeTextureLoader().load([0, 1, 2, 3, 4, 5].map(k => (`https://file.threehub.cn/` + 'files/sky/skybox.value0/' + (k + 1) + '.png')));
  ...
  const cloudTexture = new THREE.TextureLoader().load(`https://file.threehub.cn/` + 'threeExamples/shader/cloud.jpg')
